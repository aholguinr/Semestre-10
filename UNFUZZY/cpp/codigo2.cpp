...
miSLD::miSLD()
{
    ...
    var->rangoMinimo(20);
    var->rangoMaximo(100);
    cd=new ConjuntoL(20,40,80);
    var->adicionarConjuntos(cd);
    cd=new ConjuntoTriangulo(40,60,80);
    var->adicionarConjuntos(cd);
    cd=new ConjuntoGamma(40,80,100);
    var->adicionarConjuntos(cd);
    dif=new DifusorSinglenton(100,0.8);
    dif->numeroPuntos(1);
    var->difusorEntrada(dif);
    var->nombreVariable("temperatura");
    var->numeroIntervalos(20);
    entradas->adicionarVariable(var);
    var=new Variable(3);
    var->rangoMinimo(0);
    var->rangoMaximo(100);
    cd=new ConjuntoL(0,30,70);
    var->adicionarConjuntos(cd);
    cd=new ConjuntoTriangulo(30,50,70);
    var->adicionarConjuntos(cd);
    cd=new ConjuntoGamma(30,70,100);
    var->adicionarConjuntos(cd);
    var->nombreVariable("gas");
    var->numeroIntervalos(20);
